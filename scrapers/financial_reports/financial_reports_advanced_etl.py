...
class FinancialReportsAdvancedEtlScraper(BaseScraper):
    """Financial Reports Advanced Etl Scraper"""
    
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__(config)
        self.config = get_scraper_config("financial_reports_advanced_etl")
