...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("deploy_week3.log"), logging.StreamHandler()],
)
...
class Week3Deployment:
    ...
    def deploy_backend_services(self):
        ...
        try:
            ...
            routers = ["portfolio.py", "notifications.py", "risk_analytics.py"]
    ...
    def configure_environment(self):
        ...
        try:
            ...
            if not self.vapid_public_key or not self.vapid_private_key:
                logger.warning(
                    "⚠️  VAPID keys not configured - push notifications will be limited"
                )
