...
def get_database_url():
    ...
    if not database_url:
        ...
        logger.error("Please set one of: DATABASE_URL, SUPABASE_DB_URL, POSTGRES_URL, or DB_URL")
        sys.exit(1)
...
def main():
    ...
    try:
        ...
        sql_file_path = Path(__file__).parent.parent / "database" / "advanced_features_incremental.sql"
