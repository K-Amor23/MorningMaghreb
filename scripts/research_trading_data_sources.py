            ...
            try:
                ...
                if "dataset" in data:
                    ...
                    results[dataset] = {
                        ...
                        "latest_date": dataset_info.get("data", [[]])[0][0] if dataset_info.get("data") else None
                    }
                else:
                    results[dataset] = {
                        "success": False,
...
def main():
    ...
    alpha_vantage_key = input("Enter Alpha Vantage API key (or press Enter to skip): ").strip()
