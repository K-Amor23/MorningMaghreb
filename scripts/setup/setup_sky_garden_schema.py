...
class SkyGardenSchemaSetup:
    ...
    async def create_table_via_rest(
        self, table_name: str, columns: list, description: str
    ) -> bool:
        ...
        try:
            ...
            async with self.session.post(url, json=sample_data) as response:
                if response.status in [
                    ...
                    201,
                    422,
                ]:  # 422 means table exists but constraint failed
    ...
    async def create_market_status_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "market_status", columns, "Market status table"
        )
    ...
    async def create_comprehensive_market_data_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "comprehensive_market_data", columns, "Comprehensive market data table"
        )
    ...
    async def create_company_news_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "company_news", columns, "Company news table"
        )
    ...
    async def create_dividend_announcements_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "dividend_announcements", columns, "Dividend announcements table"
        )
    ...
    async def create_earnings_announcements_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "earnings_announcements", columns, "Earnings announcements table"
        )
    ...
    async def create_corporate_actions_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "corporate_actions", columns, "Corporate actions table"
        )
    ...
    async def create_market_sentiment_table(self) -> bool:
        ...
        return await self.create_table_via_rest(
            "market_sentiment", columns, "Market sentiment table"
        )
        ...
        try:
            ...
            async with self.session.post(url, json=sample_market_status) as response:
                if response.status in [200, 201]:
                    ...
                    logger.warning(
                        f"⚠️ Could not insert sample market status: {response.status}"
                    )
            ...
            async with self.session.post(url, json=sample_market_data) as response:
                if response.status in [200, 201]:
                    ...
                    logger.warning(
                        f"⚠️ Could not insert sample market data: {response.status}"
                    )
