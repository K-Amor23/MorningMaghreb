-- Sky Garden Comprehensive Database Schema (Ultra Safe Version)
-- Run this script in your Supabase dashboard SQL editor
-- This script safely handles existing tables, columns, and indexes
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'comprehensive_market_data' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_comprehensive_market_data_ticker') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'comprehensive_market_data' AND column_name = 'sector') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_comprehensive_market_data_sector') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'comprehensive_market_data' AND column_name = 'scraped_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_comprehensive_market_data_scraped_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'company_news' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_company_news_ticker') THEN
        CREATE INDEX idx_company_news_ticker ON company_news(ticker);
        RAISE NOTICE 'Created index idx_company_news_ticker';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'company_news' AND column_name = 'published_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_company_news_published_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'company_news' AND column_name = 'category') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_company_news_category') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'dividend_announcements' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_dividend_announcements_ticker') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'dividend_announcements' AND column_name = 'ex_date') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_dividend_announcements_ex_date') THEN
        CREATE INDEX idx_dividend_announcements_ex_date ON dividend_announcements(ex_date);
        RAISE NOTICE 'Created index idx_dividend_announcements_ex_date';
    END IF;
    
    -- Earnings Announcements indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'earnings_announcements' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_earnings_announcements_ticker') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'earnings_announcements' AND column_name = 'report_date') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_earnings_announcements_report_date') THEN
        CREATE INDEX idx_earnings_announcements_report_date ON earnings_announcements(report_date);
        RAISE NOTICE 'Created index idx_earnings_announcements_report_date';
    END IF;
    
    -- ETF Data indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'etf_data' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_etf_data_ticker') THEN
        CREATE INDEX idx_etf_data_ticker ON etf_data(ticker);
        RAISE NOTICE 'Created index idx_etf_data_ticker';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'etf_data' AND column_name = 'asset_class') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_etf_data_asset_class') THEN
        CREATE INDEX idx_etf_data_asset_class ON etf_data(asset_class);
        RAISE NOTICE 'Created index idx_etf_data_asset_class';
    END IF;
    
    -- Corporate Actions indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'corporate_actions' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_corporate_actions_ticker') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'corporate_actions' AND column_name = 'action_type') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_corporate_actions_action_type') THEN
        CREATE INDEX idx_corporate_actions_action_type ON corporate_actions(action_type);
        RAISE NOTICE 'Created index idx_corporate_actions_action_type';
    END IF;
    
    -- Market Sentiment indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'market_sentiment' AND column_name = 'ticker') 
       AND NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_market_sentiment_ticker') THEN
...
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'market_status' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_market_status_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'comprehensive_market_data' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_comprehensive_market_data_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'company_news' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_company_news_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'dividend_announcements' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_dividend_announcements_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'earnings_announcements' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_earnings_announcements_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'etf_data' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_etf_data_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'corporate_actions' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_corporate_actions_updated_at') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'market_sentiment' AND column_name = 'updated_at') 
       AND NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_market_sentiment_updated_at') THEN
...
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_status') 
       AND NOT EXISTS (SELECT 1 FROM market_status LIMIT 1) THEN
    ...
    ELSE
        RAISE NOTICE 'Market status table already has data or does not exist, skipping sample insert';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'comprehensive_market_data') 
       AND NOT EXISTS (SELECT 1 FROM comprehensive_market_data LIMIT 1) THEN
    ...
    ELSE
        RAISE NOTICE 'Comprehensive market data table already has data or does not exist, skipping sample insert';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_status') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'market_status' AND rowsecurity = true) THEN
        ALTER TABLE market_status ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on market_status';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'comprehensive_market_data') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'comprehensive_market_data' AND rowsecurity = true) THEN
        ALTER TABLE comprehensive_market_data ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on comprehensive_market_data';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'company_news') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'company_news' AND rowsecurity = true) THEN
        ALTER TABLE company_news ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on company_news';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'dividend_announcements') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'dividend_announcements' AND rowsecurity = true) THEN
        ALTER TABLE dividend_announcements ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on dividend_announcements';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'earnings_announcements') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'earnings_announcements' AND rowsecurity = true) THEN
        ALTER TABLE earnings_announcements ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on earnings_announcements';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'etf_data') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'etf_data' AND rowsecurity = true) THEN
        ALTER TABLE etf_data ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on etf_data';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'corporate_actions') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'corporate_actions' AND rowsecurity = true) THEN
        ALTER TABLE corporate_actions ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'Enabled RLS on corporate_actions';
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_sentiment') 
       AND NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'market_sentiment' AND rowsecurity = true) THEN
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_status') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'market_status' AND policyname = 'Allow public read access to market_status') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_status') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'market_status' AND policyname = 'Allow authenticated users to insert market_status') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'comprehensive_market_data') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'comprehensive_market_data' AND policyname = 'Allow public read access to comprehensive_market_data') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'comprehensive_market_data') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'comprehensive_market_data' AND policyname = 'Allow authenticated users to insert comprehensive_market_data') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'company_news') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'company_news' AND policyname = 'Allow public read access to company_news') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'company_news') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'company_news' AND policyname = 'Allow authenticated users to insert company_news') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'dividend_announcements') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'dividend_announcements' AND policyname = 'Allow public read access to dividend_announcements') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'dividend_announcements') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'dividend_announcements' AND policyname = 'Allow authenticated users to insert dividend_announcements') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'earnings_announcements') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'earnings_announcements' AND policyname = 'Allow public read access to earnings_announcements') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'earnings_announcements') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'earnings_announcements' AND policyname = 'Allow authenticated users to insert earnings_announcements') THEN
    ...
    -- ETF Data policies
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'etf_data') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'etf_data' AND policyname = 'Allow public read access to etf_data') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'etf_data') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'etf_data' AND policyname = 'Allow authenticated users to insert etf_data') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'corporate_actions') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'corporate_actions' AND policyname = 'Allow public read access to corporate_actions') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'corporate_actions') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'corporate_actions' AND policyname = 'Allow authenticated users to insert corporate_actions') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_sentiment') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'market_sentiment' AND policyname = 'Allow public read access to market_sentiment') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'market_sentiment') 
       AND NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'market_sentiment' AND policyname = 'Allow authenticated users to insert market_sentiment') THEN
