...
def verify_tables(supabase: Client):
    ...
    expected_tables = [
        'companies', 'company_prices', 'company_reports', 'company_news',
        'profiles', 'watchlists', 'watchlist_items', 'price_alerts',
        'sentiment_votes', 'sentiment_aggregates', 'newsletter_subscribers',
        'newsletter_campaigns', 'contests', 'contest_entries', 'contest_prizes',
        'contest_notifications', 'paper_trading_accounts', 'paper_trading_orders',
        'paper_trading_positions', 'portfolios', 'portfolio_holdings',
        'ai_summaries', 'chat_queries', 'user_profiles', 'cse_companies',
        'market_data'
    ]
